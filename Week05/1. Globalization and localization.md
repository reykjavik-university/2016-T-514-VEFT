...
```
The action controller does not require any specific language methods. The Get works for all cultures and the test result of a Get should return the correct string for a given localization.
