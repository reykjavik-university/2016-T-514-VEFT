...
After .NET Core has been [downloaded](https://www.microsoft.com/net/core), we can either create a new project using
[Visual Studio](https://docs.asp.net/en/latest/tutorials/first-web-api.html), or alternatively we can use the following commands to create a new API project:
